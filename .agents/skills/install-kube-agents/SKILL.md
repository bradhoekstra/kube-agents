...
| `--scope-projects=IDS`                  | GCP projects beyond the host project whose GKE clusters get a Cluster Agent (space- or comma-separated); the read roles are bound in each                                                                                                                  | _unset_                                                                                                                                            |
