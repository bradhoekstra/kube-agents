...
`docs/design/10-audit-logging-user-attribution.md` non-goals), and content read from the cluster,
...
| **Insufficient attribution** | Trace/session IDs + authenticated requester carried through telemetry and audit records                                                                                                                                                                                                                                                                                                             | `review-security-k8s-agents-audit-logs`, `docs/design/10-audit-logging-user-attribution.md` |
