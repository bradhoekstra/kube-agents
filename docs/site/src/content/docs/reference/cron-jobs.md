...
| `no_agent`         | bool            | Set on the Planning Agent's four plumbing jobs and on the Platform Agent's six non-watchdog entries, `github-repo-watcher`, `eod-event-watcher-daily-report`, `findings-morning-nudge`, `kanban-workspace-gc`, `kanban-board-health` and `chat-delivery-watch`: the tick is a subprocess, not an LLM turn. The governance watchdogs omit it.                                                                                                                                                                                                                             |
