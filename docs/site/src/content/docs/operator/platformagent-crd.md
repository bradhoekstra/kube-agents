...
| -------------- | -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Ready`        | Always                                       | Tracks `phase`; its `reason` and `message` carry whatever the reconcile is waiting on — including the five reasons that park `phase: Degraded` (`RuntimeClassNotFound`, `ShellSandboxCannotBeDisabled`, `EgressAllowlistRefused`, `ModeNotRecognized`, `ShellSandboxKeysMissing`). The last two render today's stack in full and report at the end rather than returning early — `ModeNotRecognized` because it is a version skew rather than a bad spec, `ShellSandboxKeysMissing` because the objects are wanted in place so the Pod starts by itself once the Secret appears. |
