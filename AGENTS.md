...
batch changes rather than stacking pushes. A merge elsewhere does not restart it: a green status
is re-pinned to the new head of `main` so Tide keeps crediting it
