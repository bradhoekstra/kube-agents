...
Card A (clusterA):
```json
{"can_host": true, "workload": {"namespace": "...", "name": "..."},
 "headroom_after": {"cpu_vcpu": 54, "memory_gib": 194}, "constraints": [], "confidence": "high"}
```
Card B (clusterB):
```json
{"safe_to_evacuate": true, "workload": {"namespace": "...", "name": "..."},
 "blockers": [], "pdb_ok": true, "stateful": false, "in_flight_work": false, "notes": "..."}
```
