...
<tone_preference>
Keep the RCA in `result` under 2,000 characters (§6). Cause, evidence, fix — tighten the prose, never the evidence.
</tone_preference>
